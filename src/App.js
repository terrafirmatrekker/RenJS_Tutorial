...
const contractAddress = "0x06d3dab0d76f24e3d22c9079be1631acf6426d66";
...
class App extends React.Component {
  ...
  updateBalance = async () => {
    ...
    this.setState({ balance: parseInt(balance.toString()) / 10 ** 8 }); // eslint-disable-line no-use-before-define
  }
